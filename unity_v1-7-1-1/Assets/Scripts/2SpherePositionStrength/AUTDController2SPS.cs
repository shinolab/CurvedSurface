...
public class AUTDController2SPS : MonoBehaviour
{
    private Manager2SPS _manager;
    private SphereController2SPS _sphereController;
    ...
    void Start()
    {
        ...
        _sphereController = GameObject.Find("SphereController").GetComponent<SphereController2SPS>();
