...
public class AUTDEuroDemo2 : MonoBehaviour
{
    private ManagerEuroDemo2 _manager;
    private BumpsEuroDemo2 _bumpsController;
    ...
    void Start()
    {
        ...
        _bumpsController = GameObject.Find("BumpsController").GetComponent<BumpsEuroDemo2>();
