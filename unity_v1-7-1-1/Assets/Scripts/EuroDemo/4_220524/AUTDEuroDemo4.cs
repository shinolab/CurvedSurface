...
public class AUTDEuroDemo4 : MonoBehaviour
{
    private ManagerEuroDemo4 _manager;
    private BumpsEuroDemo4 _bumpsController;
    ...
    private float FindTargetBumpPosX(List<float> list, float value)
    {
        ...
        {
            list.Add(0.01f + (i * distance)); //0.01f<=RightBump.transform.position.x
            list.Add(-0.01f - (i * distance)); //-0.01f<=LeftBump.transform.position.x
        }
    ...
    void Start()
    {
        ...
        _bumpsController = GameObject.Find("BumpsController").GetComponent<BumpsEuroDemo4>();
