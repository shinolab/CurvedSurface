...
public class FingerController2C3D : MonoBehaviour
{
    private Manager2C3D _manager;
    private AUTDController2C3D _autdController;
    ...
    void Start()
    {
        ...
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController2C3D>();
