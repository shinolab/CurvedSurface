...
public class PlaneController2C3D : MonoBehaviour
{
    ...
    private void DetectPlane()
    {
        ...
        // Y(+X)
        vertList.Add(new Vector3(curveDistance / 2 + halfCurveLength, 0, -width) + planeYZ);    //0
        vertList.Add(new Vector3(curveDistance / 2 + halfCurveLength, 0, width) + planeYZ); //1
        ...
        vertList.Add(new Vector3(-curveDistance / 2 - halfCurveLength, 0, width) + planeYZ); //6
        vertList.Add(new Vector3(-curveDistance / 2 - halfCurveLength, 0, -width) + planeYZ);//7
        ...
        {
            vertList.Add(new Vector3(-curveDistance / 2 + halfCurveLength, 0, -width) + planeYZ); //8
            vertList.Add(new Vector3(-curveDistance / 2 + halfCurveLength, 0, width) + planeYZ);  //9
            vertList.Add(new Vector3(curveDistance / 2 - halfCurveLength, 0, width) + planeYZ);   //10
            vertList.Add(new Vector3(curveDistance / 2 - halfCurveLength, 0, -width) + planeYZ);  //11
