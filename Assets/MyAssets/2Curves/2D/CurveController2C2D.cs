...
public class CurveController2C2D : MonoBehaviour
{
    ...
    private void CreateConvex()
    {
        ...
        for (int i = 0; i <= max; i++)
        {
            ...
            vertList.Add(new Vector3(v2 * (curveRadius - width) - curveDistance / 2, v1 * (curveRadius - width), 0));
            vertList.Add(new Vector3(v2 * curveRadius - curveDistance / 2, v1 * curveRadius, 0));
    ...
    private void CreateConvene()
    {
        ...
        for (int i = 0; i <= max; i++)
        {
            ...
            if ((i <= max - 1) && (i > 0))
            {
                triList.Add(2 * max + 2 * i + 3); triList.Add(2 * max + 2 * i + 1); triList.Add(2 * max + 2 * i);
                triList.Add(2 * max + 2 * i + 3); triList.Add(2 * max + 2 * i); triList.Add(2 * i + 2);
            }
