...
public class FingerController2C2D : MonoBehaviour
{
    private Manager2C2D _manager;
    private AUTDController2C2D _autdController;
    ...
    void Start()
    {
        ...
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController2C2D>();
