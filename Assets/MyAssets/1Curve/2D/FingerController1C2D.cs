...
public class FingerController1C2D : MonoBehaviour
{
    private Manager1C2D _manager;
    private AUTDController1C2D _autdController;
    ...
    void Start()
    {
        ...
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController1C2D>();
