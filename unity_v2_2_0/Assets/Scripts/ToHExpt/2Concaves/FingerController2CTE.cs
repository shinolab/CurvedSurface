...
public class FingerController2CTE : MonoBehaviour
{
    private Manager2CTE _manager;
    private AUTDController2CTE _autdController;
    ...
    void Start()
    {
        ...
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController2CTE>();
