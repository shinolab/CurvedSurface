...
public class FingerController2VTE : MonoBehaviour
{
    private Manager2VTE _manager;
    private CurvesController2VTE _curvesController;
    private AUTDController2VTE _autdController;
    ...
    void Start()
    {
        _manager = GameObject.Find("Manager").GetComponent<Manager2VTE>();
        _curvesController = GameObject.Find("CurvesController").GetComponent<CurvesController2VTE>();
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController2VTE>();
