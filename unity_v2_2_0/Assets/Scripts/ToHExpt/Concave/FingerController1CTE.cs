...
public class FingerController1CTE : MonoBehaviour
{
    private Manager1CTE _manager;
    private ConcaveController1CTE _concaveController;
    private AUTDController1CTE _autdController;
    ...
    void Start()
    {
        ...
        _concaveController = GameObject.Find("ConcaveBox").GetComponent<ConcaveController1CTE>();

        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController1CTE>();
