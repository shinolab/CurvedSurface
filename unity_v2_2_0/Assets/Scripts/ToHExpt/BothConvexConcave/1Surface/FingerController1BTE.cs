...
public class FingerController1BTE : MonoBehaviour
{
    private Manager1BTE _manager;
    private AUTDController1BTE _autdController;
    ...
    void Start()
    {
        ...
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController1BTE>();
