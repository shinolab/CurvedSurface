...
public class FingerController1BPS2D : MonoBehaviour
{
    private Manager1BPS2D _manager;
    private AUTDController1BPS2D _autdController;
    ...
    void Start()
    {
        _manager = GameObject.Find("Manager").GetComponent<Manager1BPS2D>();
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController1BPS2D>();
