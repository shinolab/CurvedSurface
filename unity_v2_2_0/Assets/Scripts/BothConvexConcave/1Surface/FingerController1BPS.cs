...
public class FingerController1BPS : MonoBehaviour
{
    private Manager1BPS _manager;
    private AUTDController1BPS _autdController;
    ...
    void Start()
    {
        ...
        _autdController = GameObject.Find("AUTDController").GetComponent<AUTDController1BPS>();
